...
"fast-1": {
    ...
    events: [
        ...
        },
        {
            ...
            address: "Tran's Garage, 9631 Bolsa Avenue, Westminster, Orange County",
        ...
        },
        {
            ...
            lat: 33.7449, lng: -117.9630,
            address: "9631 Bolsa Avenue, Westminster, Orange County",
            description: "Brian rides into Little Saigon with Dom, passing under the ornamental gateway that marks the boundary of Tran's turf. For Brian it's his first glimpse of the world Johnny Tran controls — a neighborhood where the FBI's badge means nothing and Dom's reputation is the only currency that matters.",
            characters: "Brian O'Conner, Dom Toretto, Johnny Tran, Lance Nguyen"
        },
        {
            ...
            lat: 33.7449, lng: -117.9630,
            address: "9631 Bolsa Avenue, Westminster, Orange County",
            description: "Dom drives through the Asian gateway into Little Saigon with Brian riding shotgun. He knows exactly where he's going — this isn't Dom's first visit to Tran's territory, and the history between their families runs deeper than Brian realizes.",
            characters: "Dom Toretto, Brian O'Conner, Johnny Tran, Lance Nguyen"
        },
        {
            id: "speed-shop-tran",
